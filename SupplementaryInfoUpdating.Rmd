...
p=1
  for(prior_set in c('p1','p2','p3')){
   ...
   header= paste(
    ...
    cat("\n")  
    cat(header)
    caption1 = paste("Estimates of Fixed Effects for Model ", p , " with prior set ", prior_set, " for " WhichTaxa, " taxa, at the ", GenusVsSpecies, " level",  sep = '' )
    table1<- knitr::kable(FixedEffectsTables[1], caption = caption1, "latex")
    print(table1)
    
    caption2 = paste("Comparisons of Fixed Effects for Model ", p , " with prior set ", prior_set, " for " WhichTaxa, " taxa, at the ", GenusVsSpecies, " level",  sep = '' )
