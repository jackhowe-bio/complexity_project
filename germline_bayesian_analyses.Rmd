...
fit_cellnumber_fission_phy<-
  brm(data = df,
      family=poisson(), # family of model
      formula = cell_number ~ FissionOrBuddingObserved_Genus_nominal + (1|gr(species_id, cov = CovarMatrix)),
      prior = prior(normal(0, 10), class = "b", coef = "FissionOrBuddingObserved_Genus_nominalyes"),
      iter = 1000000, warmup = 100000, chains = 5, thin = 1000, cores = 5, file = 'fits/fit_phy_FissionCellNumber', file_refit = "on_change", # same simple prior
      data2 = list(CovarMatrix = CovarMatrix))
