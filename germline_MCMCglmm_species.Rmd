...
```{r}
testing_args <- expand.grid(n_itts = as.integer(seq(100000, 10000000, length = 7)), n_thin = as.integer(seq(100,1000, length = 2)), n_burn = as.integer(seq(500000, 1000000, length = 4)))
