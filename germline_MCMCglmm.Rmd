...
M2_parallel <- mclapply(1:6, function(i){
 MCMCglmm(cell_types ~ FissionOrBuddingObserved_Genus-1 + scale(log(cell_number)), #-1 here removes the intercept equivalent to 0 in brms
                family ="poisson",data = df,prior=p1, nitt=2000000, burnin=100000, thin=1000,verbose = T,pr=T)
}, mc.cores = 4)
