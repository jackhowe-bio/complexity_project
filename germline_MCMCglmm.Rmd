...
M1.1<- MCMCglmm(cell_number ~ FissionOrBuddingObserved_Genus-1, #-1 here removes the intercept equivalent to 0 in brms
                ,data = df,prior=p1, nitt=1000000, burnin=100000, thin=1000,verbose = F,pr=T, family ="poisson")
print('1 finished')
M1.2<- MCMCglmm(cell_number ~FissionOrBuddingObserved_Genus-1,family ="poisson",data = df,prior=p1, nitt=1000000, burnin=100000, thin=1000,verbose = F,pr=T)
print('2 finished')
M1.3<- MCMCglmm(cell_number ~FissionOrBuddingObserved_Genus-1, family ="poisson",data = df,prior=p1, nitt=1000000, burnin=100000, thin=1000,verbose = F,pr=T)
print('3 finished')
...
m1_parallel <- mclapply(1:6, function(i){
 MCMCglmm(cell_number ~ FissionOrBuddingObserved_Genus-1, #-1 here removes the intercept equivalent to 0 in brms
                family ="poisson",data = df,prior=p1, nitt=1000000, burnin=100000, thin=1000,verbose = T,pr=T)
}, mc.cores = 4)
...
#fit the model (run 3 times to assess convergence - can be parallelised using mclapply())
P1.1<- MCMCglmm(cell_number ~FissionOrBuddingObserved_Genus-1, #-1 here removes the intercept equivalent to 0 in brms
                ...
                family ="poisson",data = df,prior=p2, nitt=1000000, burnin=100000, thin=1000,verbose = FALSE,pr=T)
print('1 finished')
P1.2<- MCMCglmm(cell_number ~FissionOrBuddingObserved_Genus_nominal-1,random = ~species, ginverse=list(species=inv_tree),family ="poisson",data = df,prior=p2, nitt=1000000, burnin=100000, thin=1000,verbose = FALSE,pr=T)
print('2 finished')
P1.3<- MCMCglmm(cell_number ~FissionOrBuddingObserved_Genus_nominal-1, random = ~species, ginverse=list(species=inv_tree),family ="poisson",data = df,prior=p2, nitt=1000000, burnin=100000, thin=1000,verbose = FALSE,pr=T)
print('3 finished')
