...
diagnostic_filename<- paste(PathForAnalyses, 'R_Objects/ModelDiagnostics/p', i,'/Model4_ROTL_p',i, '.pdf', sep = '')
ggmcmc::ggmcmc(M4_Sol_gg, file = diagnostic_filename)

MCMCglmm_filename<- paste(PathForAnalyses, 'R_Objects/ModelOutputs/p', i,'/Model4_ROTL_p',i, '.RDS', sep = '')
