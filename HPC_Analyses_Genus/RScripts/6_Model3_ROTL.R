...
diagnostic_filename<- paste('RScripts/ModelDiagnostics/p', i,'/Model3_ROTL_p',i, '.pdf', sep = '')
#ggmcmc::ggmcmc(M3_Sol_gg, file = diagnostic_filename)

MCMCglmm_filename<- paste('RScripts/ModelOutputs/p', i,'/Model3_ROTL_p',i, '.RDS', sep = '')
