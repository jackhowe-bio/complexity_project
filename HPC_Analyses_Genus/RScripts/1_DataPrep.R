...
setwd('/Users/pcx971/Documents/oxford/complexity/complexity_project/HPC_Analyses_Genus/')# See https://cran.r-project.org/web/packages/rotl/vignettes/meta-analysis.html 
...
metadata<- multicell_data %>% select(species, kingdom, phylum, Obligate_or_facultative, Simple_or_complex, Sterile_soma,
                                           ...
                                           FissionOrBuddingObserved_Genus, fragmentation_or_budding, germline_timing, germline_timing_simple) %>%
