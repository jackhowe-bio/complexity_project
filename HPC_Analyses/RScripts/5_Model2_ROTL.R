...
diagnostic_filename<- paste('RScripts/ModelDiagnostics/p', i,'/Model2_ROTL_p',i, '.pdf', sep = '')
#ggmcmc::ggmcmc(M2_Sol_gg, file = diagnostic_filename)


MCMCglmm_filename<- paste('RScripts/ModelOutputs/p', i,'/Model2_ROTL_p',i, '.RDS', sep = '')
