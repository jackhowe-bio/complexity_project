...
Create simple model, using default undefined priors (flat).
```{r}
df %>%
...
fit_obl<-
  brm(data = df,
      ...
      iter = 600000, warmup = 10000, chains = 5, seed = 8, thin = 20, cores = 5)
...
fit_num<-
  brm(data = df,
      ...
      iter = 60000, warmup = 10000, chains = 5, seed = 8, thin = 10, cores = 5,
      prior = prior)
